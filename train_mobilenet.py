...
if __name__ == "__main__":
    ...
    model.summary()
    model.compile(optimizer = Adam(lr=1e-3), loss=earth_mover_loss)
    ...
    checkpoint = ModelCheckpoint('weights/mobilenet_weights.h5', monitor='val_loss', verbose=1, save_weights_only=False, save_best_only=True, mode='min')
